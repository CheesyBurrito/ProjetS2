...
QT_MOC_LITERAL(4, 35, 12), // "sendQuestion"
QT_MOC_LITERAL(5, 48, 16), // "std::vector<int>"
QT_MOC_LITERAL(6, 65, 9), // "setTraits"
QT_MOC_LITERAL(7, 75, 9), // "newTraits"
QT_MOC_LITERAL(8, 85, 14), // "switchZoomIcon"
QT_MOC_LITERAL(9, 100, 13) // "debugBtnClick"

    },
    "SideMenu\0lowerBarTest\0\0std::string\0"
    "sendQuestion\0std::vector<int>\0setTraits\0"
    "newTraits\0switchZoomIcon\0debugBtnClick"
};
...
void SideMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendQuestion((*reinterpret_cast< std::vector<int>(*)>(_a[1]))); break;
        case 2: _t->setTraits((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        case 3: _t->switchZoomIcon(); break;
        case 4: _t->debugBtnClick(); break;
        default: ;
        }
        ...
        {
            typedef void (SideMenu::*_t)(std::vector<int> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SideMenu::sendQuestion)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void SideMenu::sendQuestion(std::vector<int> _t1)
{
