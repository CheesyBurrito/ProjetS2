...
QT_MOC_LITERAL(1, 12, 10), // "keyPressed"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "StartWindow\0keyPressed\0"
};
...
void StartWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (StartWindow::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StartWindow::keyPressed)) {
                *result = 0;
                return;
            }
        }
