...
QT_MOC_LITERAL(1, 10, 16), // "escapeKeyPressed"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7), // "hovered"
QT_MOC_LITERAL(4, 36, 11), // "MenuButton*"
QT_MOC_LITERAL(5, 48, 16), // "setHoveredButton"
QT_MOC_LITERAL(6, 65, 6) // "button"

    },
    "PauseMenu\0escapeKeyPressed\0\0hovered\0"
    "MenuButton*\0setHoveredButton\0button"
};
...
void PauseMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->hovered((*reinterpret_cast< MenuButton*(*)>(_a[1]))); break;
        case 2: _t->setHoveredButton((*reinterpret_cast< MenuButton*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PauseMenu::escapeKeyPressed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (PauseMenu::*_t)(MenuButton * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PauseMenu::hovered)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void PauseMenu::escapeKeyPressed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void PauseMenu::hovered(MenuButton * _t1)
{
